...
document.addEventListener('DOMContentLoaded', ()=>{
    const mainSwiperContainer = document.querySelector('.main-section__swiper');
    const popularSwiperContainer = document.querySelector('.main-section__popular-swiper');
    const sectionsSwiperContainer = document.querySelector('.sections__content-swiper');
    const reviewsSwiperContainer = document.querySelector('.reviews__content-swiper');
    const infoSwiperContainer = document.querySelector('.info__swiper');
    const catalogSwiperContainer = document.querySelector('.catalog__swiper');
    // Слайдер в шапке
    if (mainSwiperContainer) {
        let swiper = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)(mainSwiperContainer, {
            modules: [
            ...
            navigation: {
                ...
                prevEl: '.main-section__arrow-prev'
            },
            pagination: {
    ...
    if (popularSwiperContainer) {
        let swiperInstance = null;
        const initSwiperOnResize = ()=>{
            const screenWidth = window.innerWidth;
            if (screenWidth < 1000) {
                if (!swiperInstance) swiperInstance = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)(popularSwiperContainer, {
                    modules: [
                        (0, $48396d89743015b3$export$2e2bcd8739ae039)
                    ],
                    slidesPerView: 2,
        ...
        initSwiperOnResize();
        window.addEventListener('resize', initSwiperOnResize);
    }
    // Слайдер "Разделы" мобильный
    if (sectionsSwiperContainer) {
        let swiperInstance = null;
        const initSwiperOnResize = ()=>{
            const screenWidth = window.innerWidth;
            if (screenWidth < 1000) {
                if (!swiperInstance) swiperInstance = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)(sectionsSwiperContainer, {
                    modules: [
                        (0, $48396d89743015b3$export$2e2bcd8739ae039)
                    ],
                    slidesPerView: 2,
                    spaceBetween: 16,
                    pagination: {
                        el: '.sections__swiper-pagination',
                        type: 'progressbar'
                    },
                    breakpoints: {
                        700: {
    ...
    // Сладйер "Отзывы" мобильный
    if (reviewsSwiperContainer) {
        let swiperInstance = null;
        const initReviewsSwiperOnResize = ()=>{
            const screenWidth = window.innerWidth;
            if (screenWidth < 1000) {
                if (!swiperInstance) swiperInstance = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)(reviewsSwiperContainer, {
                    modules: [
                        (0, $48396d89743015b3$export$2e2bcd8739ae039)
                    ],
                    slidesPerView: 1,
        ...
        initReviewsSwiperOnResize();
        window.addEventListener('resize', initReviewsSwiperOnResize);
    }
    // Слайдер перед футером мобильный
    if (infoSwiperContainer) {
        let swiperInstance = null;
        const initInfoSwiperOnResize = ()=>{
            const screenWidth = window.innerWidth;
            if (screenWidth < 1000) {
                if (!swiperInstance) swiperInstance = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)(infoSwiperContainer, {
                    modules: [
                        (0, $48396d89743015b3$export$2e2bcd8739ae039)
                    ],
                    slidesPerView: 1,
        ...
        initInfoSwiperOnResize();
        window.addEventListener('resize', initInfoSwiperOnResize);
    }
    // Сладйер "Каталог" мобильный
    if (catalogSwiperContainer) {
        let swiperInstance = null;
        const initInfoSwiperOnResize = ()=>{
            const screenWidth = window.innerWidth;
            if (screenWidth < 1000) {
                if (!swiperInstance) swiperInstance = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)(catalogSwiperContainer, {
                    modules: [
                        (0, $48396d89743015b3$export$2e2bcd8739ae039)
                    ],
                    slidesPerView: 1,
...
document.addEventListener('DOMContentLoaded', ()=>{
    const burgerBtn = document.querySelector('.js__burger-btn');
    const burgerMenu = document.querySelector('.js__burger-menu');
    if (burgerBtn && burgerMenu) burgerBtn.addEventListener('click', ()=>{
        burgerMenu.classList.toggle('burger--visible');
...
"use strict";
var $4201ee584f37f61b$export$126649350cd02471;
(function(PipsMode) {
...
})($4201ee584f37f61b$export$126649350cd02471 || ($4201ee584f37f61b$export$126649350cd02471 = {}));
var $4201ee584f37f61b$export$ab20e68cdcd7a4fc;
(function(PipsType) {
    PipsType[PipsType["None"] = -1] = "None";
    PipsType[PipsType["NoValue"] = 0] = "NoValue";
    PipsType[PipsType["LargeValue"] = 1] = "LargeValue";
    PipsType[PipsType["SmallValue"] = 2] = "SmallValue";
})($4201ee584f37f61b$export$ab20e68cdcd7a4fc || ($4201ee584f37f61b$export$ab20e68cdcd7a4fc = {}));
//region Helper Methods
function $4201ee584f37f61b$var$isValidFormatter(entry) {
    return $4201ee584f37f61b$var$isValidPartialFormatter(entry) && typeof entry.from === "function";
}
function $4201ee584f37f61b$var$isValidPartialFormatter(entry) {
    // partial formatters only need a to function and not a from function
    return typeof entry === "object" && typeof entry.to === "function";
}
function $4201ee584f37f61b$var$removeElement(el) {
    el.parentElement.removeChild(el);
}
function $4201ee584f37f61b$var$isSet(value) {
    return value !== null && value !== undefined;
}
// Bindable version
function $4201ee584f37f61b$var$preventDefault(e) {
    e.preventDefault();
}
// Removes duplicates from an array.
function $4201ee584f37f61b$var$unique(array) {
    return array.filter(function(a) {
        return !this[a] ? this[a] = true : false;
    }, {});
}
// Round a value to the closest 'to'.
function $4201ee584f37f61b$var$closest(value, to) {
    return Math.round(value / to) * to;
}
// Current position of an element relative to the document.
function $4201ee584f37f61b$var$offset(elem, orientation) {
    var rect = elem.getBoundingClientRect();
    var doc = elem.ownerDocument;
    var docElem = doc.documentElement;
    var pageOffset = $4201ee584f37f61b$var$getPageOffset(doc);
...
function $4201ee584f37f61b$var$isNumeric(a) {
    return typeof a === "number" && !isNaN(a) && isFinite(a);
}
// Sets a class and removes it after [duration] ms.
function $4201ee584f37f61b$var$addClassFor(element, className, duration) {
    if (duration > 0) {
        $4201ee584f37f61b$var$addClass(element, className);
        setTimeout(function() {
            $4201ee584f37f61b$var$removeClass(element, className);
        }, duration);
    }
}
// Limits a value to 0 - 100
function $4201ee584f37f61b$var$limit(a) {
    return Math.max(Math.min(a, 100), 0);
}
// Wraps a variable as an array, if it isn't one yet.
// Note that an input array is returned by reference!
function $4201ee584f37f61b$var$asArray(a) {
    return Array.isArray(a) ? a : [
        a
    ];
}
// Counts decimals
function $4201ee584f37f61b$var$countDecimals(numStr) {
    numStr = String(numStr);
    var pieces = numStr.split(".");
    return pieces.length > 1 ? pieces[1].length : 0;
}
// http://youmightnotneedjquery.com/#add_class
function $4201ee584f37f61b$var$addClass(el, className) {
    if (el.classList && !/\s/.test(className)) el.classList.add(className);
    else el.className += " " + className;
}
// http://youmightnotneedjquery.com/#remove_class
function $4201ee584f37f61b$var$removeClass(el, className) {
    if (el.classList && !/\s/.test(className)) el.classList.remove(className);
    else el.className = el.className.replace(new RegExp("(^|\\b)" + className.split(" ").join("|") + "(\\b|$)", "gi"), " ");
}
// https://plainjs.com/javascript/attributes/adding-removing-and-testing-for-classes-9/
function $4201ee584f37f61b$var$hasClass(el, className) {
    return el.classList ? el.classList.contains(className) : new RegExp("\\b" + className + "\\b").test(el.className);
}
// https://developer.mozilla.org/en-US/docs/Web/API/Window/scrollY#Notes
function $4201ee584f37f61b$var$getPageOffset(doc) {
...
function $4201ee584f37f61b$var$getActions() {
...
// Issue #785
function $4201ee584f37f61b$var$getSupportsPassive() {
...
function $4201ee584f37f61b$var$getSupportsTouchActionNone() {
    return window.CSS && CSS.supports && CSS.supports("touch-action", "none");
}
//endregion
//region Range Calculation
// Determine the size of a sub-range in relation to a full range.
function $4201ee584f37f61b$var$subRangeRatio(pa, pb) {
    return 100 / (pb - pa);
}
// (percentage) How many percent is this value of this range?
function $4201ee584f37f61b$var$fromPercentage(range, value, startRange) {
    return value * 100 / (range[startRange + 1] - range[startRange]);
}
// (percentage) Where is this value on this range?
function $4201ee584f37f61b$var$toPercentage(range, value) {
    return $4201ee584f37f61b$var$fromPercentage(range, range[0] < 0 ? value + Math.abs(range[0]) : value - range[0], 0);
}
// (value) How much is this percentage on this range?
function $4201ee584f37f61b$var$isPercentage(range, value) {
    return value * (range[1] - range[0]) / 100 + range[0];
}
function $4201ee584f37f61b$var$getJ(value, arr) {
    var j = 1;
    while(value >= arr[j])j += 1;
    return j;
}
// (percentage) Input a value, find where, on a scale of 0-100, it applies.
function $4201ee584f37f61b$var$toStepping(xVal, xPct, value) {
    if (value >= xVal.slice(-1)[0]) return 100;
    var j = $4201ee584f37f61b$var$getJ(value, xVal);
    var va = xVal[j - 1];
    var vb = xVal[j];
    var pa = xPct[j - 1];
    var pb = xPct[j];
    return pa + $4201ee584f37f61b$var$toPercentage([
        va,
        vb
    ], value) / $4201ee584f37f61b$var$subRangeRatio(pa, pb);
}
// (value) Input a percentage, find where it is on the specified range.
function $4201ee584f37f61b$var$fromStepping(xVal, xPct, value) {
    // There is no range group that fits 100
    if (value >= 100) return xVal.slice(-1)[0];
    var j = $4201ee584f37f61b$var$getJ(value, xPct);
    var va = xVal[j - 1];
    var vb = xVal[j];
    var pa = xPct[j - 1];
    var pb = xPct[j];
    return $4201ee584f37f61b$var$isPercentage([
        va,
        vb
    ], (value - pa) * $4201ee584f37f61b$var$subRangeRatio(pa, pb));
}
// (percentage) Get the step that applies at a certain value.
function $4201ee584f37f61b$var$getStep(xPct, xSteps, snap, value) {
    ...
    return xPct[j - 1] + $4201ee584f37f61b$var$closest(value - xPct[j - 1], xSteps[j - 1]);
}
//endregion
//region Spectrum
var $4201ee584f37f61b$var$Spectrum = /** @class */ function() {
    function Spectrum(entry, snap, singleStep) {
        ...
        Object.keys(entry).forEach(function(index) {
            ordered.push([
                $4201ee584f37f61b$var$asArray(entry[index]),
                index
            ]);
        });
    ...
    Spectrum.prototype.getDistance = function(value) {
        var distances = [];
        for(var index = 0; index < this.xNumSteps.length - 1; index++)distances[index] = $4201ee584f37f61b$var$fromPercentage(this.xVal, value, index);
        return distances;
    };
    ...
    Spectrum.prototype.toStepping = function(value) {
        value = $4201ee584f37f61b$var$toStepping(this.xVal, this.xPct, value);
        return value;
    };
    Spectrum.prototype.fromStepping = function(value) {
        return $4201ee584f37f61b$var$fromStepping(this.xVal, this.xPct, value);
    };
    Spectrum.prototype.getStep = function(value) {
        value = $4201ee584f37f61b$var$getStep(this.xPct, this.xSteps, this.snap, value);
        return value;
    };
    Spectrum.prototype.getDefaultStep = function(value, isDown, size) {
        var j = $4201ee584f37f61b$var$getJ(value, this.xPct);
    ...
    Spectrum.prototype.countStepDecimals = function() {
        var stepDecimals = this.xNumSteps.map($4201ee584f37f61b$var$countDecimals);
    ...
    Spectrum.prototype.handleEntryPoint = function(index, value) {
        ...
        if (!$4201ee584f37f61b$var$isNumeric(percentage) || !$4201ee584f37f61b$var$isNumeric(value[0])) throw new Error("noUiSlider: 'range' value isn't numeric.");
        // Store values.
    ...
    Spectrum.prototype.handleStepPoint = function(i, n) {
        ...
        this.xSteps[i] = $4201ee584f37f61b$var$fromPercentage([
            this.xVal[i],
            this.xVal[i + 1]
        ], n, 0) / $4201ee584f37f61b$var$subRangeRatio(this.xPct[i], this.xPct[i + 1]);
...
var $4201ee584f37f61b$var$defaultFormatter = {
    to: function(value) {
        return value === undefined ? "" : value.toFixed(2);
    },
    from: Number
};
var $4201ee584f37f61b$export$c1c0562ec8379000 = {
    target: "target",
    base: "base",
    origin: "origin",
    handle: "handle",
...
var $4201ee584f37f61b$var$INTERNAL_EVENT_NS = {
    tooltips: ".__tooltips",
    aria: ".__aria"
};
//endregion
function $4201ee584f37f61b$var$testStep(parsed, entry) {
    if (!$4201ee584f37f61b$var$isNumeric(entry)) throw new Error("noUiSlider: 'step' is not numeric.");
    // The step option can still be used to set stepping
    // for linear sliders. Overwritten if set in 'range'.
    parsed.singleStep = entry;
}
function $4201ee584f37f61b$var$testKeyboardPageMultiplier(parsed, entry) {
    if (!$4201ee584f37f61b$var$isNumeric(entry)) throw new Error("noUiSlider: 'keyboardPageMultiplier' is not numeric.");
    parsed.keyboardPageMultiplier = entry;
}
function $4201ee584f37f61b$var$testKeyboardMultiplier(parsed, entry) {
    if (!$4201ee584f37f61b$var$isNumeric(entry)) throw new Error("noUiSlider: 'keyboardMultiplier' is not numeric.");
    parsed.keyboardMultiplier = entry;
}
function $4201ee584f37f61b$var$testKeyboardDefaultStep(parsed, entry) {
    if (!$4201ee584f37f61b$var$isNumeric(entry)) throw new Error("noUiSlider: 'keyboardDefaultStep' is not numeric.");
    parsed.keyboardDefaultStep = entry;
}
function $4201ee584f37f61b$var$testRange(parsed, entry) {
    // Filter incorrect input.
    if (typeof entry !== "object" || Array.isArray(entry)) throw new Error("noUiSlider: 'range' is not an object.");
    // Catch missing start or end.
    if (entry.min === undefined || entry.max === undefined) throw new Error("noUiSlider: Missing 'min' or 'max' in 'range'.");
    parsed.spectrum = new $4201ee584f37f61b$var$Spectrum(entry, parsed.snap || false, parsed.singleStep);
}
function $4201ee584f37f61b$var$testStart(parsed, entry) {
    entry = $4201ee584f37f61b$var$asArray(entry);
...
function $4201ee584f37f61b$var$testSnap(parsed, entry) {
    if (typeof entry !== "boolean") throw new Error("noUiSlider: 'snap' option must be a boolean.");
    // Enforce 100% stepping within subranges.
    parsed.snap = entry;
}
function $4201ee584f37f61b$var$testAnimate(parsed, entry) {
    if (typeof entry !== "boolean") throw new Error("noUiSlider: 'animate' option must be a boolean.");
    // Enforce 100% stepping within subranges.
    parsed.animate = entry;
}
function $4201ee584f37f61b$var$testAnimationDuration(parsed, entry) {
    if (typeof entry !== "number") throw new Error("noUiSlider: 'animationDuration' option must be a number.");
    parsed.animationDuration = entry;
}
function $4201ee584f37f61b$var$testConnect(parsed, entry) {
    var connect = [
        false
    ];
    var i;
...
function $4201ee584f37f61b$var$testOrientation(parsed, entry) {
...
function $4201ee584f37f61b$var$testMargin(parsed, entry) {
    if (!$4201ee584f37f61b$var$isNumeric(entry)) throw new Error("noUiSlider: 'margin' option must be numeric.");
    // Issue #582
    if (entry === 0) return;
    parsed.margin = parsed.spectrum.getDistance(entry);
}
function $4201ee584f37f61b$var$testLimit(parsed, entry) {
    if (!$4201ee584f37f61b$var$isNumeric(entry)) throw new Error("noUiSlider: 'limit' option must be numeric.");
    parsed.limit = parsed.spectrum.getDistance(entry);
    if (!parsed.limit || parsed.handles < 2) throw new Error("noUiSlider: 'limit' option is only supported on linear sliders with 2 or more handles.");
}
function $4201ee584f37f61b$var$testPadding(parsed, entry) {
    var index;
    if (!$4201ee584f37f61b$var$isNumeric(entry) && !Array.isArray(entry)) throw new Error("noUiSlider: 'padding' option must be numeric or array of exactly 2 numbers.");
    if (Array.isArray(entry) && !(entry.length === 2 || $4201ee584f37f61b$var$isNumeric(entry[0]) || $4201ee584f37f61b$var$isNumeric(entry[1]))) throw new Error("noUiSlider: 'padding' option must be numeric or array of exactly 2 numbers.");
    if (entry === 0) return;
...
function $4201ee584f37f61b$var$testDirection(parsed, entry) {
...
function $4201ee584f37f61b$var$testBehaviour(parsed, entry) {
    ...
    if (fixed) {
        ...
        $4201ee584f37f61b$var$testMargin(parsed, parsed.start[1] - parsed.start[0]);
    }
...
function $4201ee584f37f61b$var$testTooltips(parsed, entry) {
    if (entry === false) return;
    if (entry === true || $4201ee584f37f61b$var$isValidPartialFormatter(entry)) {
        parsed.tooltips = [];
        ...
        entry.forEach(function(formatter) {
            if (typeof formatter !== "boolean" && !$4201ee584f37f61b$var$isValidPartialFormatter(formatter)) throw new Error("noUiSlider: 'tooltips' must be passed a formatter or 'false'.");
        });
        parsed.tooltips = entry;
    }
}
function $4201ee584f37f61b$var$testHandleAttributes(parsed, entry) {
    if (entry.length !== parsed.handles) throw new Error("noUiSlider: must pass a attributes for all handles.");
    parsed.handleAttributes = entry;
}
function $4201ee584f37f61b$var$testAriaFormat(parsed, entry) {
    if (!$4201ee584f37f61b$var$isValidPartialFormatter(entry)) throw new Error("noUiSlider: 'ariaFormat' requires 'to' method.");
    parsed.ariaFormat = entry;
}
function $4201ee584f37f61b$var$testFormat(parsed, entry) {
    if (!$4201ee584f37f61b$var$isValidFormatter(entry)) throw new Error("noUiSlider: 'format' requires 'to' and 'from' methods.");
    parsed.format = entry;
}
function $4201ee584f37f61b$var$testKeyboardSupport(parsed, entry) {
    if (typeof entry !== "boolean") throw new Error("noUiSlider: 'keyboardSupport' option must be a boolean.");
    parsed.keyboardSupport = entry;
}
function $4201ee584f37f61b$var$testDocumentElement(parsed, entry) {
    // This is an advanced option. Passed values are used without validation.
    parsed.documentElement = entry;
}
function $4201ee584f37f61b$var$testCssPrefix(parsed, entry) {
    if (typeof entry !== "string" && entry !== false) throw new Error("noUiSlider: 'cssPrefix' must be a string or `false`.");
    parsed.cssPrefix = entry;
}
function $4201ee584f37f61b$var$testCssClasses(parsed, entry) {
...
function $4201ee584f37f61b$var$testOptions(options) {
    ...
    var parsed = {
        ...
        ariaFormat: $4201ee584f37f61b$var$defaultFormatter,
        format: $4201ee584f37f61b$var$defaultFormatter
    };
    // Tests are executed in the order they are presented here.
    var tests = {
        step: {
            r: false,
            t: $4201ee584f37f61b$var$testStep
        },
        keyboardPageMultiplier: {
            r: false,
            t: $4201ee584f37f61b$var$testKeyboardPageMultiplier
        },
        keyboardMultiplier: {
            r: false,
            t: $4201ee584f37f61b$var$testKeyboardMultiplier
        },
        keyboardDefaultStep: {
            r: false,
            t: $4201ee584f37f61b$var$testKeyboardDefaultStep
        },
        start: {
            r: true,
            t: $4201ee584f37f61b$var$testStart
        },
        connect: {
            r: true,
            t: $4201ee584f37f61b$var$testConnect
        },
        direction: {
            r: true,
            t: $4201ee584f37f61b$var$testDirection
        },
        snap: {
            r: false,
            t: $4201ee584f37f61b$var$testSnap
        },
        animate: {
            r: false,
            t: $4201ee584f37f61b$var$testAnimate
        },
        animationDuration: {
            r: false,
            t: $4201ee584f37f61b$var$testAnimationDuration
        },
        range: {
            r: true,
            t: $4201ee584f37f61b$var$testRange
        },
        orientation: {
            r: false,
            t: $4201ee584f37f61b$var$testOrientation
        },
        margin: {
            r: false,
            t: $4201ee584f37f61b$var$testMargin
        },
        limit: {
            r: false,
            t: $4201ee584f37f61b$var$testLimit
        },
        padding: {
            r: false,
            t: $4201ee584f37f61b$var$testPadding
        },
        behaviour: {
            r: true,
            t: $4201ee584f37f61b$var$testBehaviour
        },
        ariaFormat: {
            r: false,
            t: $4201ee584f37f61b$var$testAriaFormat
        },
        format: {
            r: false,
            t: $4201ee584f37f61b$var$testFormat
        },
        tooltips: {
            r: false,
            t: $4201ee584f37f61b$var$testTooltips
        },
        keyboardSupport: {
            r: true,
            t: $4201ee584f37f61b$var$testKeyboardSupport
        },
        documentElement: {
            r: false,
            t: $4201ee584f37f61b$var$testDocumentElement
        },
        cssPrefix: {
            r: true,
            t: $4201ee584f37f61b$var$testCssPrefix
        },
        cssClasses: {
            r: true,
            t: $4201ee584f37f61b$var$testCssClasses
        },
        handleAttributes: {
            r: false,
            t: $4201ee584f37f61b$var$testHandleAttributes
        }
    };
    var defaults = {
        connect: false,
        ...
        cssPrefix: "noUi-",
        cssClasses: $4201ee584f37f61b$export$c1c0562ec8379000,
    ...
    Object.keys(tests).forEach(function(name) {
        ...
        if (!$4201ee584f37f61b$var$isSet(options[name]) && defaults[name] === undefined) {
            if (tests[name].r) throw new Error("noUiSlider: '" + name + "' is required.");
            return;
        }
        tests[name].t(parsed, !$4201ee584f37f61b$var$isSet(options[name]) ? defaults[name] : options[name]);
    });
...
//endregion
function $4201ee584f37f61b$var$scope(target, options, originalOptions) {
    var actions = $4201ee584f37f61b$var$getActions();
    var supportsTouchActionNone = $4201ee584f37f61b$var$getSupportsTouchActionNone();
    var supportsPassive = supportsTouchActionNone && $4201ee584f37f61b$var$getSupportsPassive();
    ...
    function addNodeTo(addTarget, className) {
        ...
        if (className) $4201ee584f37f61b$var$addClass(div, className);
    ...
    function addOrigin(base, handleNumber) {
        ...
        if (handleNumber === 0) $4201ee584f37f61b$var$addClass(handle, options.cssClasses.handleLower);
        else if (handleNumber === options.handles - 1) $4201ee584f37f61b$var$addClass(handle, options.cssClasses.handleUpper);
    ...
    function addSlider(addTarget) {
        ...
        $4201ee584f37f61b$var$addClass(addTarget, options.cssClasses.target);
        if (options.dir === 0) $4201ee584f37f61b$var$addClass(addTarget, options.cssClasses.ltr);
        else $4201ee584f37f61b$var$addClass(addTarget, options.cssClasses.rtl);
        if (options.ort === 0) $4201ee584f37f61b$var$addClass(addTarget, options.cssClasses.horizontal);
        else $4201ee584f37f61b$var$addClass(addTarget, options.cssClasses.vertical);
        var textDirection = getComputedStyle(addTarget).direction;
        if (textDirection === "rtl") $4201ee584f37f61b$var$addClass(addTarget, options.cssClasses.textDirectionRtl);
        else $4201ee584f37f61b$var$addClass(addTarget, options.cssClasses.textDirectionLtr);
    ...
    function removeTooltips() {
        if (scope_Tooltips) {
            removeEvent("update" + $4201ee584f37f61b$var$INTERNAL_EVENT_NS.tooltips);
            scope_Tooltips.forEach(function(tooltip) {
                if (tooltip) $4201ee584f37f61b$var$removeElement(tooltip);
            });
            scope_Tooltips = null;
        }
    }
    ...
    function tooltips() {
        ...
        bindEvent("update" + $4201ee584f37f61b$var$INTERNAL_EVENT_NS.tooltips, function(values, handleNumber, unencoded) {
    ...
    function aria() {
        removeEvent("update" + $4201ee584f37f61b$var$INTERNAL_EVENT_NS.aria);
        bindEvent("update" + $4201ee584f37f61b$var$INTERNAL_EVENT_NS.aria, function(values, handleNumber, unencoded, tap, positions) {
    ...
    function getGroup(pips) {
        // Use the range.
        if (pips.mode === $4201ee584f37f61b$export$126649350cd02471.Range || pips.mode === $4201ee584f37f61b$export$126649350cd02471.Steps) return scope_Spectrum.xVal;
        if (pips.mode === $4201ee584f37f61b$export$126649350cd02471.Count) {
        ...
        if (pips.mode === $4201ee584f37f61b$export$126649350cd02471.Positions) // Map all percentages to on-range values.
        return mapToRange(pips.values, pips.stepped);
        if (pips.mode === $4201ee584f37f61b$export$126649350cd02471.Values) {
    ...
    function generateSpread(pips) {
        ...
        group = $4201ee584f37f61b$var$unique(group.slice().sort(function(a, b) {
            return a - b;
        }));
        ...
        group.forEach(function(current, index) {
            ...
            var realSteps;
            var stepSize;
            var isSteps = pips.mode === $4201ee584f37f61b$export$126649350cd02471.Steps;
            ...
            for(i = low; i <= high; i = safeIncrement(i, step)){
                ...
                type = group.indexOf(i) > -1 ? $4201ee584f37f61b$export$ab20e68cdcd7a4fc.LargeValue : isSteps ? $4201ee584f37f61b$export$ab20e68cdcd7a4fc.SmallValue : $4201ee584f37f61b$export$ab20e68cdcd7a4fc.NoValue;
    ...
    function addMarking(spread, filterFunc, formatter) {
        ...
        var valueSizeClasses = (_a = {}, _a[$4201ee584f37f61b$export$ab20e68cdcd7a4fc.None] = "", _a[$4201ee584f37f61b$export$ab20e68cdcd7a4fc.NoValue] = options.cssClasses.valueNormal, _a[$4201ee584f37f61b$export$ab20e68cdcd7a4fc.LargeValue] = options.cssClasses.valueLarge, _a[$4201ee584f37f61b$export$ab20e68cdcd7a4fc.SmallValue] = options.cssClasses.valueSub, _a);
        var markerSizeClasses = (_b = {}, _b[$4201ee584f37f61b$export$ab20e68cdcd7a4fc.None] = "", _b[$4201ee584f37f61b$export$ab20e68cdcd7a4fc.NoValue] = options.cssClasses.markerNormal, _b[$4201ee584f37f61b$export$ab20e68cdcd7a4fc.LargeValue] = options.cssClasses.markerLarge, _b[$4201ee584f37f61b$export$ab20e68cdcd7a4fc.SmallValue] = options.cssClasses.markerSub, _b);
        ...
        $4201ee584f37f61b$var$addClass(element, options.cssClasses.pips);
        $4201ee584f37f61b$var$addClass(element, options.ort === 0 ? options.cssClasses.pipsHorizontal : options.cssClasses.pipsVertical);
        ...
        function addSpread(offset, value, type) {
            ...
            if (type === $4201ee584f37f61b$export$ab20e68cdcd7a4fc.None) return;
            // Add a marker for every point
            var node = addNodeTo(element, false);
            node.className = getClasses(type, options.cssClasses.marker);
            node.style[options.style] = offset + "%";
            // Values are only appended for points marked '1' or '2'.
            if (type > $4201ee584f37f61b$export$ab20e68cdcd7a4fc.NoValue) {
    ...
    function removePips() {
        if (scope_Pips) {
            $4201ee584f37f61b$var$removeElement(scope_Pips);
            scope_Pips = null;
        }
    }
    function pips(pips) {
    ...
    function attachEvent(events, element, callback, data) {
        ...
        var method = function(event) {
            ...
            if ($4201ee584f37f61b$var$hasClass(scope_Target, options.cssClasses.tap) && !data.doNotReject) return false;
    ...
    function fixEvent(e, pageOffset, eventTarget) {
        ...
        pageOffset = pageOffset || $4201ee584f37f61b$var$getPageOffset(scope_Document);
        if (mouse || pointer) {
    ...
    function calcPointToPercentage(calcPoint) {
        var location = calcPoint - $4201ee584f37f61b$var$offset(scope_Base, options.ort);
        var proposal = location * 100 / baseSize();
        // Clamp proposal between 0% and 100%
        // Out-of-bound coordinates may occur when .noUi-base pseudo-elements
        // are used (e.g. contained handles feature)
        proposal = $4201ee584f37f61b$var$limit(proposal);
    ...
    function eventEnd(event, data) {
        ...
        if (data.handle) {
            $4201ee584f37f61b$var$removeClass(data.handle, options.cssClasses.active);
        ...
        if (scope_ActiveHandlesCount === 0) {
            ...
            $4201ee584f37f61b$var$removeClass(scope_Target, options.cssClasses.drag);
            setZindex();
            // Remove cursor styles and text-selection events bound to the body.
            if (event.cursor) {
                scope_Body.style.cursor = "";
                scope_Body.removeEventListener("selectstart", $4201ee584f37f61b$var$preventDefault);
            }
        }
    ...
    function eventStart(event, data) {
        ...
        if (data.handleNumbers.length === 1) {
            ...
            $4201ee584f37f61b$var$addClass(handle, options.cssClasses.active);
        }
        ...
        if (event.cursor) {
            ...
            if (scope_Handles.length > 1) $4201ee584f37f61b$var$addClass(scope_Target, options.cssClasses.drag);
            ...
            scope_Body.addEventListener("selectstart", $4201ee584f37f61b$var$preventDefault, false);
        }
        data.handleNumbers.forEach(function(handleNumber) {
    ...
    function eventTap(event) {
        ...
        if (!options.events.snap) $4201ee584f37f61b$var$addClassFor(scope_Target, options.cssClasses.tap, options.animationDuration);
    ...
    function bindSliderEvents(behaviour) {
        ...
        if (behaviour.drag) scope_Connects.forEach(function(connect, index) {
            ...
            $4201ee584f37f61b$var$addClass(connect, options.cssClasses.draggable);
    ...
    function isInternalNamespace(namespace) {
        return namespace === $4201ee584f37f61b$var$INTERNAL_EVENT_NS.aria || namespace === $4201ee584f37f61b$var$INTERNAL_EVENT_NS.tooltips;
    }
    ...
    function checkHandlePosition(reference, handleNumber, to, lookBackward, lookForward, getValue, smoothSteps) {
        ...
        to = $4201ee584f37f61b$var$limit(to);
    ...
    function valueSet(input, fireSetEvent, exactInput) {
        var values = $4201ee584f37f61b$var$asArray(input);
        var isInit = scope_Locations[0] === undefined;
        // Event fires by default
        fireSetEvent = fireSetEvent === undefined ? true : fireSetEvent;
        // Animation is optional.
        // Make sure the initial values were set before using animated placement.
        if (options.animate && !isInit) $4201ee584f37f61b$var$addClassFor(scope_Target, options.cssClasses.tap, options.animationDuration);
    ...
    function destroy() {
        ...
        removeEvent($4201ee584f37f61b$var$INTERNAL_EVENT_NS.aria);
        removeEvent($4201ee584f37f61b$var$INTERNAL_EVENT_NS.tooltips);
        Object.keys(options.cssClasses).forEach(function(key) {
            $4201ee584f37f61b$var$removeClass(scope_Target, options.cssClasses[key]);
        });
    ...
    function updateOptions(optionsToUpdate, fireSetEvent) {
        ...
        var newOptions = $4201ee584f37f61b$var$testOptions(originalOptions);
        ...
        scope_Locations = [];
        valueSet($4201ee584f37f61b$var$isSet(optionsToUpdate.start) ? optionsToUpdate.start : v, fireSetEvent);
    ...
    function invertConnects() {
        ...
        $4201ee584f37f61b$var$testConnect(options, // inverse the connect boolean array
...
function $4201ee584f37f61b$export$185802fd694ee1f5(target, originalOptions) {
    if (!target || !target.nodeName) throw new Error("noUiSlider: create requires a single element, got: " + target);
    // Throw an error if the slider was already initialized.
    if (target.noUiSlider) throw new Error("noUiSlider: Slider was already initialized.");
    // Test the options and create the slider environment;
    var options = $4201ee584f37f61b$var$testOptions(originalOptions);
    var api = $4201ee584f37f61b$var$scope(target, options, originalOptions);
    target.noUiSlider = api;
    return api;
}
var $4201ee584f37f61b$export$2e2bcd8739ae039 = {
    // Exposed for unit testing, don't use this in your application.
    __spectrum: $4201ee584f37f61b$var$Spectrum,
    // A reference to the default classes, allows global changes.
    // Use the cssClasses option for changes to one slider.
    cssClasses: $4201ee584f37f61b$export$c1c0562ec8379000,
    create: $4201ee584f37f61b$export$185802fd694ee1f5
};



document.addEventListener("DOMContentLoaded", function() {
    const slider = document.getElementById("slider-range-min");
    const sliderMob = document.getElementById("slider-range-min--mob");
    const sliderTexts = document.querySelectorAll(".slider-text");
    const initializeSlider = (sliderElement, textElement)=>{
        if (sliderElement && textElement) {
            // Создаем слайдер диапазона
            (0, $4201ee584f37f61b$export$2e2bcd8739ae039).create(sliderElement, {
                start: [
                    0,
                    300000
                ],
            ...
            const updateValues = (values)=>{
                ...
                textElement.innerText = `${formattedMin} \u{20BD} - ${formattedMax} \u{20BD}.`;
            };
            // Устанавливаем начальные значения
            updateValues(sliderElement.noUiSlider.get());
    ...
    // Инициализируем слайдеры и связываем с текстовыми элементами
    if (slider && sliderTexts[0]) initializeSlider(slider, sliderTexts[0]);
    if (sliderMob && sliderTexts[1]) initializeSlider(sliderMob, sliderTexts[1]);
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (passwordField && togglePassword1) togglePassword1.addEventListener('click', function() {
        togglePasswordVisibility(passwordField);
    });
    if (repeatPasswordField && togglePassword2) togglePassword2.addEventListener('click', function() {
        togglePasswordVisibility(repeatPasswordField);
    });
...
document.addEventListener('DOMContentLoaded', ()=>{
    const quntityBtnPlus = document.querySelectorAll('.js__quantity-plus');
    const quntityBtnMinus = document.querySelectorAll('.js__quantity-minus');
    const cartTotalElement = document.querySelector('.js__cart-total');
    if (!quntityBtnPlus.lenght && !quntityBtnMinus) return;
    function updateCartTotal() {
        let total = 0;
        document.querySelectorAll('.cart__item').forEach((cartItem)=>{
            const totalElement = cartItem.querySelector('.js__quantity-total');
            if (totalElement) {
                const itemTotal = parseFloat(totalElement.textContent.replace(/\D/g, '')) || 0;
                total += itemTotal;
            }
        });
        if (cartTotalElement) cartTotalElement.textContent = total.toLocaleString() + " \u20BD";
    }
    quntityBtnPlus.forEach((btn)=>{
        btn.addEventListener('click', function() {
            const cartItem = this.closest('.cart__item');
            const quantityElement = cartItem.querySelector('.js__quantity');
            const totalElement = cartItem.querySelector('.js__quantity-total');
            if (quantityElement && totalElement) {
                ...
                if (!isNaN(quantity)) {
                    ...
                    const pricePerItem = parseFloat(totalElement.dataset.price) || 0;
                    totalElement.textContent = Math.round(quantity * pricePerItem).toLocaleString() + " \u20BD";
                    updateCartTotal();
                }
            }
        });
    });
    quntityBtnMinus.forEach((btn)=>{
        btn.addEventListener('click', function() {
            const cartItem = this.closest('.cart__item');
            const quantityElement = cartItem.querySelector('.js__quantity');
            const totalElement = cartItem.querySelector('.js__quantity-total');
...
document.addEventListener('DOMContentLoaded', ()=>{
    document.querySelectorAll('.account__head-btn').forEach((anchor)=>{
    ...
    const selectAllCheckbox = document.querySelector('.js__select-all');
    const itemCheckboxes = document.querySelectorAll('.js__item-checkbox');
    if (selectAllCheckbox && itemCheckboxes) {
        ...
        itemCheckboxes.forEach((checkbox)=>{
            checkbox.addEventListener('change', ()=>{
                if ([
                    ...itemCheckboxes
                ].some((item)=>!item.checked)) selectAllCheckbox.checked = false;
